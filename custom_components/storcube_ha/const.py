...
MQTT_TOPIC_POWER = f"{MQTT_TOPIC_PREFIX}/power"
MQTT_TOPIC_SOLAR = f"{MQTT_TOPIC_PREFIX}/solar"
MQTT_TOPIC_BATTERY = f"{MQTT_TOPIC_PREFIX}/battery"
MQTT_TOPIC_OUTPUT = f"{MQTT_TOPIC_PREFIX}/output"
MQTT_TOPIC_FIRMWARE = f"{MQTT_TOPIC_PREFIX}/firmware"
MQTT_TOPIC_THRESHOLD = f"{MQTT_TOPIC_PREFIX}/threshold"
